...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create react-remix-threejs-6817
  fly apps create react-remix-threejs-6817-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app react-remix-threejs-6817
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app react-remix-threejs-6817-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'react-remix-threejs-6817-staging' does not match app name in config file 'react-remix-threejs-6817'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name react-remix-threejs-6817-db
  fly postgres attach --app react-remix-threejs-6817 react-remix-threejs-6817-db

  fly postgres create --name react-remix-threejs-6817-staging-db
  fly postgres attach --app react-remix-threejs-6817-staging react-remix-threejs-6817-staging-db
  ```
